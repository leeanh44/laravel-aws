<header class="c-header c-header-light c-header-fixed c-header-with-subheader">
    ...
    <ul class="c-header-nav ml-auto mr-4">
        <li class="c-header-nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
                <a class="dropdown-item" href="{{ route('shop.logout') }}" onclick="event.preventDefault();
                        document.getElementById('logout-form').submit();">
                    <i class="cil-account-logout" aria-hidden="true"></i>　
                    {{ __('shop::common.labels.logout') }}
                </a>
    ...
    <div class="c-subheader px-3 breadcrumbs">
        {{ Breadcrumbs::view('shop::includes.partials.breadcrumbs') }}
    </div>
</header>
