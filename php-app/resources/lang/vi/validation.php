...
return [
    ...
    */
    ...
    'between'         => [
        ...
        'string'  => 'Trường :attribute chỉ cho phép nhập từ :min đến :max ký tự.',
    ...
    'required_without'     => 'Trường :attribute không được bỏ trống.',
    ...
    */
    ...
    'attributes' => [
        ...
        'birthdate'             => 'ngày sinh',
        'products'              => 'sản phẩm',
        'action_title'          => 'tiêu đề nút kêu gọi',
        'action_url'            => 'trang liên kết',
